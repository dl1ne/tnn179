...
$(TNNINI):	$(MAKEFILE)
	...
	echo "#-------------------------------------------------" >>$(TNNINI)
	echo "device 23" >>$(TNNINI)
	echo "kisstype 22" >>$(TNNINI)
	echo "port 11" >>$(TNNINI)
	echo "device 8081" >>$(TNNINI)
	echo "kisstype 23" >>$(TNNINI)
	echo "port 12" >>$(TNNINI)
	echo "device 10006" >>$(TNNINI)
	echo "kisstype 24" >>$(TNNINI)
	echo "port 13" >>$(TNNINI)
	echo "device 6667" >>$(TNNINI)
...
$(TNNPAS):	$(MAKEFILE)
	...
	echo ";" >>$(TNNPAS)
	echo "; Path fuer HTML Dateien" >>$(TNNPAS)
	echo "$(TNNDIR)/httpd/" >>$(TNNPAS)
	echo ";" >>$(TNNPAS)
	echo "; Path fuer SPEECH-File" >>$(TNNPAS)
	echo "$(TNNDIR)/speech/" >>$(TNNPAS)
	echo ";" >>$(TNNPAS)
	echo "; Path fuer MSG-File" >>$(TNNPAS)
	echo "$(TNNDIR)/msg/" >>$(TNNPAS)
