...
#endif
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(process_input)";
#endif /* DEBUG_MODUS */
#ifdef DEBUG_CVSCMDS_C
printf("DEBUG: cvs_cmds.c - process_input()\n");
#endif
...
static void away_command(CONNECTION *cp)
{
  ...
  CONNECTION *p;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(away_command)";
#endif /* DEBUG_MODUS */
...
static void beep_command(CONNECTION *cp)
{
  char buffer[32], *c;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(beep_command)";
#endif /* DEBUG_MODUS */
...
void bye_command2(CONNECTION *cp, char *reason)
{
  ...
  WORD channel;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(bye_command2)";
#endif /* DEBUG_MODUS */
...
#else
      send_user_change_msg(cp->name, cp->name, cp->host, cl->channel, -1, reason, currtime);
#endif /* CONVNICK */
...
#else
        send_user_change_msg(p->name, p->name, p->host, p->channel, -1, reason, currtime);
#endif /* CONVNICK */
...
static void channel_command(CONNECTION *cp)
{
  ...
  CLIST *cl;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(channel_command)";
#endif /* DEBUG_MODUS */
...
#else
    send_user_change_msg(cp->name,cp->name, cp->host, -1, newchannel, cp->pers, cp->time);
#endif /* CONVNICK */
    cl->time = currtime;
    cp->mtime = currtime;
...
#ifdef SPEECH
      speech_sprintf(buffer, speech_message(48));
...
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(charset_command)";
#endif /* DEBUG_MODUS */
...
{
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(cstat_command)";
#endif /* DEBUG_MODUS */
...
{
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(filter_command)";
#endif /* DEBUG_MODUS */
...
#endif /* L1IRC */
{
  ...
  CMDTABLE *cmdp;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(help_command)";
#endif /* DEBUG_MODUS */
...
#ifdef SPEECH
        speech_sprintf(buffer, speech_message(54));
#else
...
static void hosts_command(CONNECTION *cp)
{
  ...
  char *dest;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(hosts_command)";
#endif /* DEBUG_MODUS */
...
#endif
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(imsg_command)";
#endif /* DEBUG_MODUS */
...
static void invite_command(CONNECTION *cp)
{
  char *toname;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(invite_command)";
#endif /* DEBUG_MODUS */
...
#endif /* L1IRC */
{
  ...
  char buffer[128];
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(leave_command)";
#endif /* DEBUG_MODUS */
...
#else
    send_user_change_msg(cp->name, cp->name, cp->host, chan, -1, "/leave", cp->time);
#endif /* CONVNICK */
    cp->locked = 0;
    if (chan == cp->channel) {
#ifndef L1IRC
...
#endif /* OS_IPLINK */
{
  ...
  char buffer[256], *bp;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(scan_linksarg)";
#endif /* DEBUG_MODUS */
...
#endif /* OS_IPLINK */
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(links_command)";
#endif /* DEBUG_MODUS */
...
#endif
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(list_command)";
#endif /* DEBUG_MODUS */
  ...
  if (toname[0] == '#') {
    ...
    if (!cl) {
...
#ifdef L1IRC
      if (cp->IrcMode == TRUE)
        sprintf(buffer, ":%s 442 %s #%d :Du hast den Kanal nicht betreten!\n"
                      , myhostname
                      , cp->nickname
                      , chan);
#endif /* L1IRC */
      ...
      if (cl->channelop || !(ch->flags & M_CHAN_M)) {
        ...
        if (cp->IrcMode == TRUE)
        {
          sprintf(buffer, ":%s 404 %s :Permission Denied- You're not an IRC operator\n"
                        , myhostname
                        , cp->name);
          appendstring(cp, buffer);
        }
...
static void mode_command(CONNECTION *cp)
{
  ...
  WORD op = 0;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(mode_command)";
#endif /* DEBUG_MODUS */
...
static void name_command(CONNECTION *cp)
{
  ...
  WORD cnt;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(name_command)";
#endif /* DEBUG_MODUS */
...
#else
  send_user_change_msg(cp->name, cp->name, cp->host, -1, cp->channel, pers, currtime);
#endif /* CONVNICK */
  if (cp->channelop) {
    clear_locks();
#ifndef L1IRC
...
static void nickname_command(CONNECTION *cp)
{
  ...
  char buffer[128], *bp;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(nickname_command)";
#endif /* DEBUG_MODUS */
...
{
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(nonickname_command)";
#endif /* DEBUG_MODUS */
...
{
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(notify_command)";
#endif /* DEBUG_MODUS */
...
static void personal_command(CONNECTION *cp)
{
  ...
  char buffer[128], *bp;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(personal_command)";
#endif /* DEBUG_MODUS */
...
static void prompt_command(CONNECTION *cp)
{
  ...
  char *args, *p;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(prompt_command)";
#endif /* DEBUG_MODUS */
...
static void restart_command(CONNECTION *cp)
{
  ...
  PERMLINK *p;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(restart_command)";
#endif /* DEBUG_MODUS */
...
static void query_command(CONNECTION *cp)
{
  ...
  CONNECTION *p;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(query_command)";
#endif /* DEBUG_MODUS */
...
static void topic_command(CONNECTION *cp)
{
  ...
  WORD channel;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(topic_command)";
#endif /* DEBUG_MODUS */
...
static void uptime_command(CONNECTION *cp)
{
  char buffer[128];
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(uptime_command)";
#endif /* DEBUG_MODUS */
...
static void verbose_command(CONNECTION *cp)
{
  char buffer[32];
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(verbose_command)";
#endif /* DEBUG_MODUS */
...
static void version_command(CONNECTION *cp)
{
  char buffer[128];
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(version_command)";
#endif /* DEBUG_MODUS */
...
if (usercount != FALSE)
    ...
    if (thischan == EOF)
      ...
      appendstring(cp, buffer);
        ...
        {
#ifdef SPEECH
        speech_sprintf(buffer, speech_message(172));
...
static void width_command(CONNECTION *cp)
{
  ...
  char buffer[128];
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(width_command)";
#endif /* DEBUG_MODUS */
...
#ifdef SPEECH
    speech_sprintf(buffer, speech_message(108));
...
static void wall_command(CONNECTION *cp)
{
  ...
  char       *text;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(wall_command)";
#endif /* DEBUG_MODUS */
...
static void h_away_command(CONNECTION *cp)
{
  ...
  int changed = 1;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(h_away_command)";
#endif /* DEBUG_MODUS */
...
#endif
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(h_cmsg_command)";
#endif /* DEBUG_MODUS */
...
static void h_dest_command(CONNECTION *cp)
{
  ...
  PERMLINK *l;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(h_dest_command)";
  lastfunk = "cvs_cmds(h_dest_command)";
#endif /* DEBUG_MODUS */
...
static void h_host_command(CONNECTION *cp)
{
  ...
  CLIST       *cl;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(h_host_command)";
#endif /* DEBUG_MODUS */
...
static void h_invi_command(CONNECTION *cp)
{
  ...
  WORD channel;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(h_invi_command)";
#endif /* DEBUG_MODUS */
...
static void h_link_command(CONNECTION *cp)
{
  ...
  char *user, *host;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(h_link_command)";
#endif /* DEBUG_MODUS */
...
static void h_oper_command(CONNECTION *cp)
{
  ...
  CLIST      *cl;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(h_oper_command)";
#endif /* DEBUG_MODUS */
...
static void h_ping_command(CONNECTION *cp)
{
  ...
  char buffer[128];
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(h_ping_command)";
  lastfunk = "cvs_cmds(h_ping_command)";
#endif /* DEBUG_MODUS */
...
static void h_pong_command(CONNECTION *cp)
{
  PERMLINK *l;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(h_pong_command)";
  lastfunk = "cvs_cmds(h_pong_command)";
#endif /* DEBUG_MODUS */
...
static void h_rout_command(CONNECTION *cp)
{
  ...
  WORD ttl;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(h_rout_command)";
#endif /* DEBUG_MODUS */
...
static void h_topi_command(CONNECTION *cp)
{
  ...
  time_t time;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(h_topic_command)";
#endif /* DEBUG_MODUS */
...
{
  char *name, *host, *data, *nickname;
  CONNECTION *p;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(h_uadd_command)";
#endif /* DEBUG_MODUS */

  name = getarg(NULL, GET_NXTLC);
  host = getarg(NULL, GET_NXTLC);
  nickname = getarg(NULL, GET_NXTCS);
  getarg(NULL, GET_NXTLC);
...
static void h_udat_command(CONNECTION *cp)
{
  ...
  CONNECTION *p;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(h_udat_command)";
#endif /* DEBUG_MODUS */
...
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(h_umsg_command)";
#endif /* DEBUG_MODUS */
...
static void h_unknown_command(CONNECTION *cp)
{
  CONNECTION *p;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(h_unknown_command)";
#endif /* DEBUG_MODUS */
...
#endif
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(h_user_command)";
  lastfunk = "cvs_cmds(h_user_command)";
#endif /* DEBUG_MODUS */
...
#else
  send_user_change_msg(name, name, host, oldchannel, newchannel, pers, time);
#endif /* CONVNICK */
}
...
static void sysinfo_command(CONNECTION *cp)
{
  char buffer[255];
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(sysinfo_command)";
#endif /* DEBUG_MODUS */
...
static void hostname_command(CONNECTION *cp)
{
...
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cmds(hostname_command)";
#endif /* DEBUG_MODUS */
  ...
  if (arg[0] == FALSE)
  {
  ...
  else
    {
      ...
      {
#ifdef SPEECH
        speech_sprintf(buffer, speech_message(3));
