...
#define __AUTHOR__   "afu"       /* Monogramm des Autors/Programmierers  */
#define __PATCH__    "61"       /* Patch-Level des Autors               */

/* Zuerst legen wir die variierenden Texte mal fest                     */
#ifdef __LINUX__
#ifdef RASPBERRY
#  define __SYSTEM__                   " (Linux/Raspberry) (Afu)"
#endif
#ifdef MIPS
#  define __SYSTEM__                   " (Linux/MIPS) (Afu)"
#else
#  define __SYSTEM__                   " (Linux) (Afu)"
#endif
#else
#  ifdef __WIN32__
#    define __SYSTEM__                 " (Win32) (Afu)"
#  else
#    ifdef __GO32__
#      define __SYSTEM__               " (GO32) (Afu)"
#    else
#      ifdef ST
#        define __SYSTEM__             " (ST) (Afu)"
#      else
#        ifdef MC68302
#          define __SYSTEM__           " (TNC3) (Afu)"
#        else
#          define __SYSTEM__           " (unknown) (Afu)"
#       endif
#     endif
#   endif
# endif
...
char author[] = "*** CB-Version by DAA531 - http://cb0gla.ddns.net:8080 ***";
char autmod[] = "*** Afu-Version by DL1NE - http://github.com/dl1ne/    ***";
