...
{
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(appenddirect)";
#endif /* DEBUG_MODUS */
#ifdef DEBUG_CVSCVSD_C
printf("DEBUG: cvs_cvsd.c - appenddirect()\n");
#endif
  if (cp->up)
...
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(appendformline)";
#endif /* DEBUG_MODUS */
...
void appendstring(CONNECTION *cp, const char *string)
{
  char *p_string;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(appendstring)";
#endif /* DEBUG_MODUS */
  if (cp->up && *string) {
...
#ifdef DEBUG_CVSCVSD_C
printf("DEBUG: cvs_cvsd.c - appendstring(cp, %s)\n", p_string);
#endif
...
void appendprompt(CONNECTION *cp, const WORD ast)
{
  char x[3], *p;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(appendprompt)";
#endif /* DEBUG_MODUS */
...
void destroy_channel(WORD number)
{
  CHANNEL *ch, *ch1;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(destroy_channel)";
#endif /* DEBUG_MODUS */
...
PERMLINK *permlink_of(CONNECTION *cp)
{
  ...
  PERMLINK *l;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvsd(permlink_of)";
#endif /* DEBUG_MODUS */

  if (cp == NULL)
  {
#ifdef DEBUG_MODUS
    lastfunc = "cvs_cvsd(permlink_of cp == NULL)";
#endif /* DEBUG_MODUS */
  ...
  {
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvsd(permlink_of for schleife)";
#endif /* DEBUG_MODUS */
    l = permarray[pl];

#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvsd(permlink_of l = permarray[pl])";
#endif /* DEBUG_MODUS */

    if (l && l->connection == cp)
        {
#ifdef DEBUG_MODUS
      lastfunc = "cvs_cvsd(permlink_of l && l->connecten == cp)";
#endif /* DEBUG_MODUS */
     return(l);
        }
  }
...
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvsd(permlink_of return(NULL);)";
#endif /* DEBUG_MODUS */
...
void free_closed_connections()
{
  ...
  WORD to;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvsd(free_closed_connections)";
  lastfunk = "cvs_cvsd(free_closed_connections)";
#endif /* DEBUG_MODUS */
...
WORD count_user(WORD channel)
{
  ...
  WORD n = 0;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(count_user)";
#endif /* DEBUG_MODUS */
...
void clear_locks()
{
  CONNECTION *p;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(clear_locks)";
#endif /* DEBUG_MODUS */
...
static WORD isonchannel(CONNECTION  *cp, char *user, char *host)
{
  ...
  CLIST      *cl, *cl1;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(isonchannel)";
#endif /* DEBUG_MODUS */
...
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(send_awaymsg)";
#endif /* DEBUG_MODUS */
...
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(send_mode)";
#endif /* DEBUG_MODUS */
...
#endif /* L1IRC */
{
  ...
  CLIST *cl;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(send_opermsg)";
#endif /* DEBUG_MODUS */
                  ...
                  char *text, time_t time)
{
  ...
  CLIST *cl;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(send_persmsg)";
#endif /* DEBUG_MODUS */
                ...
                WORD channel, char *text)
{
  ...
  CLIST *cl;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(send_topic)";
#endif /* DEBUG_MODUS */
...
void send_uaddmsg(CONNECTION *cp)
{
  ...
  char buffer[1024];
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(send_uaddmsg)";
#endif /* DEBUG_MODUS */
...
#endif /* CONVNICK */
{
  ...
  CLIST *cl;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(send_user_change_msg)";
#endif /* DEBUG_MODUS */
...
#endif
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(send_msg_to_local_user)";
#endif /* DEBUG_MODUS */
...
#endif
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(send_msg_to_user)";
#endif /* DEBUG_MODUS */
...
#endif /* CONVNICK */
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(send_msg_to_channel)";
#endif /* DEBUG_MODUS */
...
void send_proto(const char *modul, const char *format, ...)
{
  ...
  char       str[1024];
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(send_proto)";
#endif /* DEBUG_MODUS */
...
#endif
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(send_invite_msg)";
#endif /* DEBUG_MODUS */

#ifdef DEBUG_CVSCVSD_C
printf("DEBUG: cvs_cvsd.c - send_inite_msg(%s, %s, %d)\n", fromname, toname, channel);
#endif
...
void update_destinations(PERMLINK *p, char *name, time_t rtt, char *rev)
{
  ...
  char buffer[256];
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(update_destinations)";
#endif /* DEBUG_MODUS */
...
#endif
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(update_permlinks)";
#endif /* DEBUG_MODUS */
...
#define MAX_WAITTIME   (60L*60L*3L)
  ...
  DESTINATION *d;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvsd(connect_permlinks)";
#endif /* DEBUG_MODUS */
...
#endif
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(personalmanager)";
#endif /* DEBUG_MODUS */
...
char *getflags(WORD flag)
{
  ...
  char        *p;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(getflags)";
#endif /* DEBUG_MODUS */
...
{
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(setstring)";
#endif /* DEBUG_MODUS */
...
CONNECTION *CheckUserCVS(char *user)
{
  CONNECTION *p;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvsd(CheckUserCVS)";
#endif /* DEBUG_MODUS */
...
#ifdef CONVNICK
                ||(!strcasecmp((p->nickname ? p->name : p->name), user))        /* Nicknamevergleich. */
#endif /* CONVNICK */
       )
...
char *convers_user(char *cuser)
{
  ...
  WORD printit;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvsd(convers_user)";
#endif /* DEBUG_MODUS */
