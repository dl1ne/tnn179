...
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvrt(get_charset_by_name)";
#endif /* DEBUG_MODUS */
...
char *get_charset_by_ind(WORD ind)
{
  struct charsets *p_charset;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvrt(get_charset_by_ind)";
#endif /* DEBUG_MODUS */
...
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvrt(list_charsets)";
#endif /* DEBUG_MODUS */
...
char *convertin(WORD in, char *string)
{
 CONVERT *cnvrt;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvrt(convertin)";
#endif /* DEBUG_MODUS */
...
char *convertout(WORD out, char *string)
{
 CONVERT *cnvrt;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvrt(convertout)";
#endif /* DEBUG_MODUS */
...
static void cvitexfn(char *d, char *string)
{
 ...
 int c;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvrt(cvitexfn)";
#endif /* DEBUG_MODUS */
...
static void cvitabfn(char *tab, char *string)
{
 ...
 int c, i;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvrt(cvitabfn)";
#endif /* DEBUG_MODUS */
...
static void cvodmbfn(char *d, char *string)
{
 ...
 int c;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvrt(cvodmbfn)";
#endif /* DEBUG_MODUS */
...
static void cvotexfn(char *d, char *string)
{
 ...
 int c;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvrt(cvotexfn)";
#endif /* DEBUG_MODUS */
...
static void cvotabfn(char *tab, char *string)
{
 ...
 int c, x;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_cvrt(cvotabfn)";
#endif /* DEBUG_MODUS */
