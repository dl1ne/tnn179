...
CONNECTION *alloc_connection(USRBLK *up)
{
  CONNECTION *cp;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_serv(alloc_connection)";
#endif /* DEBUG_MODUS */
#ifdef DEBUG_CVSSERV_C
printf("DEBUG: cvs_serv.c - alloc_connection()\n");
#endif
...
void free_connection(CONNECTION *cp)
{
  ...
  PERMLINK *p;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_serv(free_connection)";
  lastfunk = "cvs_serv(free_connection)";
#endif /* DEBUG_MODUS */
#ifdef DEBUG_CVSSERV_C
printf("DEBUG: cvs_serv.c - free_connection()\n");
#endif
...
BOOLEAN invite_ccp(char *toname, char *message)
{
  ...
  MBHEAD *mbp;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_serv(invite_ccp)";
#endif /* DEBUG_MODUS */
#ifdef DEBUG_CVSSERV_C
printf("DEBUG: cvs_serv.c - invite_ccp()\n");
#endif
...
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_serv(connect_cvshost)";
#endif /* DEBUG_MODUS */
#ifdef DEBUG_CVSSERV_C
printf("DEBUG: cvs_serv.c - connect_cvshost()\n");
#endif
...
{
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_serv(putcvsstr)";
#endif /* DEBUG_MODUS */
#ifdef DEBUG_CVSSERV_C
printf("DEBUG: cvs_serv.c - putcvsstr()\n");
#endif
...
{
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_serv(queuelength)";
#endif /* DEBUG_MODUS */
...
void convers_init(void)
{
  ...
  char *cp;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_serv(convers_init)";
#endif /* DEBUG_MODUS */
#ifdef DEBUG_CVSSERV_C
printf("DEBUG: cvs_serv.c - convers_init()\n");
#endif
...
#ifdef CONVERS_PATHCHECK
  if (strlen(textpath) <= 245)
        sprintf(tmp, "%sconvers.prs", textpath);
  else
        hprintf("*** WARNING: Path to long! (%s) ***\n",textpath);
#else
    sprintf(tmp, "%sconvers.prs", textpath);
#endif
...
{
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_serv(conversd)";
#endif /* DEBUG_MODUS */
#ifdef DEBUG_CVSSERV_C
printf("DEBUG: cvs_serv.c - conversd()\n");
#endif
...
BOOLEAN convers_input(MBHEAD *mhdp)
{
  ...
  WORD icnt;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_serv(convers_input)";
#endif /* DEBUG_MODUS */
#ifdef DEBUG_CVSSERV_C
printf("DEBUG: cvs_serv.c - convers_input()\n");
#endif
...
void convers_output()
{
  CONNECTION *cp;
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_serv(convers_output)";
#endif /* DEBUG_MODUS */
...
#endif
#ifdef DEBUG_MODUS
  lastfunc = "cvs_cvs_serv(ccpcvs)";
#endif /* DEBUG_MODUS */
#ifdef DEBUG_CVSSERV_C
printf("DEBUG: cvs_serv.c - ccpcvs()\n");
#endif
...
#else
    if (cp->IrcMode == TRUE)
      sprintf(cnvinbuf, "%s\r", ircloginbuf);
    else
      sprintf(cnvinbuf, "/NAME %s %ld\r", name, channel);
#endif /* L1IRC */
  }
