...
#ifdef ROUTESMOD_L3RTTSHOW
  ,{&L3rtt_show,  0,       1,"L3RTT-Show"}   /* Auswahl zwischen Original und Mod-Version */
#endif
...
char    lastbuf2[2048];
char   *lastfunk = lastbuf2;
FILE   *Debug_fp;
#endif

#ifdef DEBUG_MODUS_SCHLEIFENCHECK
time_t  debug_newtime;
time_t  debug_oldtime;
FILE      *fp_schleifencheck;
#endif /* DEBUG_MODUS */
