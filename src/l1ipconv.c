...
printf("DEBUG: l1ipconv.c - ShowIpcEntry()\n");
#endif
...
#ifdef DEBUG_L1IPCONF_C
printf("DEBUG: l1ipconv.c - IPConvLogin()\n");
#endif
...
#ifdef DEBUG_L1IPCONF_C
printf("DEBUG: l1ipconv.c - GetContensCVS(%c)\n", contens);
#endif
...
#ifdef DEBUG_L1IPCONF_C
printf("DEBUG: l1ipconv.c - AAA Linkpartner\n");
#endif
...
#ifdef DEBUG_L1IPCONF_C
printf("DEBUG: l1ipconv.c - AAA User\n");
#endif
    ...
    if (contens == LF) {
      ...
      /* zum naechsten Zeichen. */
#ifdef DEBUG_L1IPCONF_C
printf("DEBUG: l1ipconv.c - LF moegen wir nicht\n");
#endif
#ifdef MOD_L1IPCONV_C_LINEFEED
      tcppoi->cr = TRUE;
#else /* MOD_L1IPCONV_C_LINEFEED */
      return(NO);
#endif /* MOD_L1IPCONV_C_LINEFEED */
    }
...
#ifdef DEBUG_L1IPCONF_C
printf("DEBUG: l1ipconv.c - Frame ist komplett\n");
#endif
        return(YES);
      }
      else
        /* Return fehlt, */
#ifdef DEBUG_L1IPCONF_C
printf("DEBUG: l1ipconv.c - Return fehlt\n");
#endif
        return(ERRORS);
    }
...
printf("DEBUG: l1ipconv.c - Nicht eingeloggt?\n");
      ...
      if (CheckContens(contens))
      {
        ...
        if (!strncmp(tcppoi->cmd, "ppconvers", 9))
          ...
          /* zum naechsten Zeichen. */
#ifdef DEBUG_L1IPCONF_C
printf("DEBUG: l1ipconv.c - ungueltiges zeichen?\n");
#endif
          return(NO); }
      }
    }
...
#ifdef DEBUG_L1IPCONF_C
printf("DEBUG: l1ipconv.c - ERRORS# %c", ERRORS);
#endif
  return(ERRORS);
}
...
#ifdef DEBUG_L1IPCONF_C
printf("DEBUG: l1ipconv.c - IPConvIS()\n");
#endif
...
#ifdef DEBUG_L1IPCONF_C
printf("DEBUG: l1ipconv.c - IPConvAddTBL()\n");
#endif
...
#ifdef DEBUG_L1IPCONF_C
printf("DEBUG: l1ipconv.c - IPConvGetName()\n");
#endif
...
int IPConvGetIP(WORD *laenge, char **inbuf, unsigned char *outbuf)
{
  char  ipadresse[16 + 1];
  char *ipaddrpoi;
  char  zeichen;
...
#endif /* DEBUG_MODUS */
#ifdef DEBUG_L1IPCONF_C
  printf("DEBUG: l1ipconv.c - IPConvConnect()\n");
#endif

  if (IPConvConnectOS(call, upcall, flag))
    return(TRUE);
#ifdef DEBUG_L1IPCONF_C
printf("DEBUG: l1ipconv.c - IPConvConnect() - Returning FALSE!\n");
#endif
  return(FALSE);
}
#endif /* OS_IPLINK */
