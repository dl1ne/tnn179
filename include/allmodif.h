...
#define MOD_L1IRC_C_KICKONJOIN
#define MOD_L1IRC_C_INVITEONCONNECT
#define MOD_L1IRC_C_LINEFEED
#define MOD_L1IPCONV_C_LINEFEED
#define MOD_L1IPCONV_C_TELNETLOGIN
#define MOD_L1HTTPD_C_NEWMIMETYPES
#define MOD_L1HTTPD_C_CMDLENGTH
#define MOD_L1HTTPD_C_LOCALHOSTISSYSOP
#define MOD_L1HTTPD_C_ALLOWDOTINCMD
#define MOD_L7_C_LOCALHOSTISSYSOP
...
#define HTMLPATHFIX          /* HTML Path wird gleich TEXTPATH gesetzt   */
...
#define CONVERS_PATHCHECK    /* Pruefe Path-Laenge.                        */
...
// Funktion Schleifen-Zeitberechnung
#define DEBUG_MODUS_SCHLEIFENCHECK
